...
Now that we have observed the non-functional behavior of test suites execution in different languages, we can analyze the extreme points we have detected in previous tables to see more in deep the source of such deviation.
For that reason, we present in table 5 and 6, the raw data values of these extreme test suites.
