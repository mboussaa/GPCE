...
>>>>>>> af7017dc5830c81fb15033b3a75882a6424a1639
...
\begin{enumerate}
<<<<<<< HEAD
	\item Deploy the generated code on a set of containers
...
The rest of this section details the technical choices we have made to synthesize a testing infrastructure able to detect inconsistencies within code generators.

\subsection{Technical implementation}

<<<<<<< HEAD
The general overview of the technical implementation is shown in Figure 2. In the following subsections, we describe the deployment and testing architecture based containers.
=======
