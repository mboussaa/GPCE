...
However, based on existing benchmarks between technical environments~\cite{hundt2011loop}, in comparing the behavior of generated code of a large data set programs, our feeling is that we could detect inefficient code generators. The kind of errors we are trying to track can be resumed as following:
\begin{itemize}
